...
def inspect_full_synchronizing(model_architecture, num_models, data:list, legend:list, latent_list:list, epochs):
  ...
  fullsyn_df.to_csv(DATA_PATH_OUTPUT / 'synchronizing' / 'cardio_20models_synchronizing_ver2.csv')
  return fullsyn_df

LATENT_LIST = [21, 112, 192, 112, 16, 96, 32, 112, 112]
full_synchronizing = inspect_full_synchronizing(Autoencoder, num_models=10, data=[cardio], legend=['cardio'], latent_list=[21], epochs=2000)
