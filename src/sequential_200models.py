...
def sequential(model_architecture, num_models, latent_list: list, data:list, legend:list, epochs):
  ...
  dropsyn_df.to_csv(DATA_PATH_OUTPUT / 'rand42_200models_sequential.csv')  
  return dropsyn_df
...
dropsyn_df = sequential(Autoencoder, 200, latent_list= LATENT_LIST, data = DATA, legend = LEGEND, epochs = 2000)
print(dropsyn_df)