...
#
  ...
  num_auto_df.to_csv(DATA_PATH_OUTPUT / 'ver3_unoptimal_ind_ensemble_500e_64b.csv')
  return num_auto


#unoptimal_latent = [4, 32, 16, 4, 4, 4, 4, 64, 32] # epoch=1000,  batch=64
#num_auto_2 = plot_auc_models(Autoencoder,num_models_list=[i for i in range(1, 61)], latent_list = unoptimal_latent, data = DATA, legend = LEGEND, epochs = 1000)

unoptimal_latent_ver3 = [32, 64, 32, 8, 8, 4, 4, 128, 64]
num_auto_2 = plot_auc_models(Autoencoder,num_models_list=[i for i in range(1, 61)], latent_list = unoptimal_latent_ver3, data = DATA, legend = LEGEND, epochs = 500)
