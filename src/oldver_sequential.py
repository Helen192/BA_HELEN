...
def sequential(model_architecture, num_models, latent_list: list, data:list, legend:list, epochs):
  ...
  dropsyn_df.to_csv(DATA_PATH_OUTPUT / 'ver3_unoptimal_sequential_500e_64b.csv')  
  return dropsyn_df
...
dropsyn_df = sequential(Autoencoder, 60, latent_list= unoptimal_latent_ver3, data = DATA, legend = LEGEND, epochs = 500)
print(dropsyn_df)