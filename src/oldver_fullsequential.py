...
def full_sequential(model_architecture, num_models, latent_list: list, data:list, legend:list, epochs):
  ...
  sesyn_df.to_csv(DATA_PATH_OUTPUT / 'ver3_unoptimal_full_sequential_500e_64b.csv')
  return sesyn_df
...
#full_sequential_df = full_sequential(Autoencoder, num_models = 60, latent_list= unoptimal_latent, data = DATA, legend = LEGEND, epochs = 300)
#ver1_unoptimal_latent = [4, 32, 16, 4, 4, 4, 4, 64, 32]
#full_sequential_df = full_sequential(Autoencoder, num_models = 60, latent_list= ver1_unoptimal_latent, data = DATA, legend = LEGEND, epochs = 1000)

unoptimal_latent_ver3 = [32, 64, 32, 8, 8, 4, 4, 128, 64]
full_sequential_df = full_sequential(Autoencoder, num_models = 60, latent_list= unoptimal_latent_ver3, data = DATA, legend = LEGEND, epochs = 500)
